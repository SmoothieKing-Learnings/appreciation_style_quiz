...
export const QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q2-precise',       text: '"If we add an enhancer to 10% more orders, our team hits its goal."', styleId: 'precise' }
    ]
  },
  {
    id: 'q3',
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q8-enthusiastic',  text: 'The team is excited and the energy on the team is high.', styleId: 'enthusiastic' },
  ...
  {
    id: 'q10',
    text: 'On my team, the most important part of a conversation is…',
    options: [
